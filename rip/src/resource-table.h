...
namespace rip::cli::convert {
	...
	namespace resources {
		...
		//>;
		//using sobj = resource<ResourceType::SOBJ, "1-scu",
		//	version<"1-colors", ucsl::resources::sobj::v1::SetObjectData<GI::AllocatorSystem>>,
		//	version<"1-scu", ucsl::resources::sobj::v1::SetObjectData<GI::AllocatorSystem>>
		//>;
		//using nxs = resource<ResourceType::NXS, "1-scu",
		//	version<"1-colors", ucsl::resources::nxs::v1::NXSData>,
		//	version<"1-scu", ucsl::resources::nxs::v1::NXSData>
		//>;
		...
		//>;
		//using pba = resource<ResourceType::PBA, "1",
		//	version<"1", ucsl::resources::pba::v1::PbaData>
		//>;
		...
		//>;
		//using effdb = resource<ResourceType::PARTICLE_LOCATION, "0",
		//	version<"0", ucsl::resources::effdb::v100::EffdbData>
		//>;
